    ...
    return (
      <div className="flex flex-col items-center px-4 pt-6">
        ...
        <div className="w-full mb-4">
          ...
          <p className="text-amber-400 text-xs italic text-center mt-1">
        ...
        <p className="text-amber-400 text-xs italic mt-4">tap square to stop & review</p>
      </div>
    )
  }
        ...
        <>
          ...
          <div className="flex flex-col items-center gap-2">
            <button
              ...
              className="w-16 h-16 rounded-full border-2 border-stone-100 flex items-center justify-center hover:border-amber-400 transition-colors"
            >
              <div className="w-6 h-6 rounded-full bg-red-500" />
            </button>
            <p className="text-amber-400 text-xs italic">tap to record</p>
          </div>
        </>
      )}
